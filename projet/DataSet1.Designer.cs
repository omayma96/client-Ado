...
namespace projet {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class clientsDataTable : global::System.Data.TypedTableBase<clientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public clientsRow AddclientsRow(string nom, string prenom, string adress, string ville) {
            ...
            public string adress {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'adress\' dans la table \'clients\' est DBNull.", e);
                    }
                }
                set {
...
namespace projet.DataSet1TableAdapters {
    ...
    public partial class clientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[clients] ([nom], [prenom], [adress], [ville]) VALUES (@nom, @p" +
                "renom, @adress, @ville);\r\nSELECT id, nom, prenom, adress, ville FROM clients WHE" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clients] SET [nom] = @nom, [prenom] = @prenom, [adress] = @adress, [ville] = @ville WHERE (([id] = @Original_id) AND ((@IsNull_nom = 1 AND [nom] IS NULL) OR ([nom] = @Original_nom)) AND ((@IsNull_prenom = 1 AND [prenom] IS NULL) OR ([prenom] = @Original_prenom)) AND ((@IsNull_adress = 1 AND [adress] IS NULL) OR ([adress] = @Original_adress)) AND ((@IsNull_ville = 1 AND [ville] IS NULL) OR ([ville] = @Original_ville)));
SELECT id, nom, prenom, adress, ville FROM clients WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::projet.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nom, prenom, adress, ville FROM dbo.clients";
